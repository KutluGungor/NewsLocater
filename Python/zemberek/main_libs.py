...
class ZemberekTool:
    ...
    def cumleyi_parcalara_ayir(self, corpus):
        ...
        global stop_words
        stopwords_list = {'o', 'eğer', 'nasıl', 'biz', 'bu', 'çünkü', 'bazı', 'ya', 've', 'defa', 'ne', 'niçin', 'şu',
                      'siz', 'yani', 'sanki', 'hem', 'kez', 'nereye', 'az', 'ama', 'birkaç', 'ile', 'hepsi', 'ise',
                      'nerde', 'de', 'diye', 'kim', 'neden', 'birşey', 'mu', 'aslında', 'şey', 'acaba', 'hep', 'gibi',
                      'en', 'için', 'daha', 'hiç', 'mü', 'biri', 'belki', 'da', 'veya', 'çok', 'tüm', 'mı', 'her', 'ki',
                      'nerede', 'niye'}
